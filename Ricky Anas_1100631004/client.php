...
$result = $client->call('hello', array('name' => 'ricky anas')); //variabel result memanggil hasil client
// Check for a fault
if ($client->fault) { //memeriksa jika terjadi kesalahan
    ...
    if ($err) { //jika terjadi error
        ...
        print_r($result); //untuk menampilkan result yang dipanggil yaitu Hellooo, ricky anas
        echo '</pre>';
    }
}
