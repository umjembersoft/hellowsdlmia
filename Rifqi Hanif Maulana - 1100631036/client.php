...
$result = $client->call('hello', array('name' => 'Kiekey uchiha')); //variabel result memanggil hasil client
// Check for a fault
if ($client->fault) { //memeriksa jika terjadi kesalahan
    ...
    if ($err) { //jika terjadi error
        ...
        print_r($result); //untuk menampilkan result yang dipanggil yaitu Hellooo, Kiekey uchiha
        echo '</pre>';
    }
}
