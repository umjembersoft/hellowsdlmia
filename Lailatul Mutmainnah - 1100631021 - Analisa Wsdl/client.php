...
$wsdl = "http://localhost/LatihanWsdl/hellowsdl.php?wsdl"; //menuliskan letak client yg disimpan di folder C:xampp/htdocs/LatihanWsdl(project yang dibuat)/hellowsdl.php
...
$result = $client->call('hello', array('name' => 'Lailatul Mutmainnah')); //variabel result memanggil hasil client
// Check for a fault
if ($client->fault) { //memeriksa jika terjadi kesalahan
    ...
    if ($err) { //jika terjadi error
        ...
        print_r($result); //untuk menampilkan result yang dipanggil yaitu Hellooo, Lailatul Mutmainnah
        echo '</pre>';
    }
}
